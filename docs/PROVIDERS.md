...
**Gemini has a real trap in it**: whether Google trains on your data
...
**DeepSeek is the most exposed of the four**: their privacy policy states
...
**Also worth checking, separately from any provider's policy**: some
institutions have their own rules on using third-party AI tools on
unpublished work, which can be stricter than what a provider's terms
allow. That's specific to your institution and this extension has no way
